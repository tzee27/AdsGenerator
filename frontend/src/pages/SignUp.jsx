...
const adTypes = [
  { id: "video", label: "Video Ad", desc: "TikTok, Reels, Stories" },
  {
    id: "image",
    label: "Image Ad",
    desc: "Banners, Carousels, Product Photos",
  },
      ...
      <div className="auth-container auth-container--signup">
        ...
        <div className="auth-panel auth-panel--brand">
          ...
          <div className="auth-features">
            {[
              {
                label: "No Marketing Team Needed",
                desc: "GLM does the strategy work for you.",
              },
              {
                label: "Multi-Platform Ready",
                desc: "Shopee, Lazada, TikTok, Instagram, Facebook.",
              },
              {
                label: "Trend-Aware Content",
                desc: "Always relevant, always timely.",
              },
            ].map((f) => (
        ...
        <div className="auth-panel auth-panel--form auth-panel--form-tall">
          ...
          <form className="auth-form" onSubmit={handleSubmit}>
            <div className="auth-form__row">
              ...
              <div className="form-group">
                <label className="form-label" htmlFor="signup-business">
                  Business / Store Name
                </label>
                <input
                  id="signup-business"
